"""
Django settings for medlyte project.
...
SECRET_KEY = '!793k-p6m9a=10_3ipb3stsm1(*)y99)dpj5q1-i_mqkpifap*'
...
ROOT_URLCONF = 'medlyte.urls'

WSGI_APPLICATION = 'medlyte.wsgi.application'
...
SITE_ID = 1
AUTH_USER_MODEL = 'provider_auth.DemoUser'
